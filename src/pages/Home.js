            ...
            <div ref={container} className="container-home">
                <div ref={container} className="forms-container">
                    ...
                    <form  className="sign-in-form form">
                        ...
                        <button type="submit"  className="btn1 solid" onClick={handleSubmitAfter}>Login</button>
                    </form>
                    <form onSubmit={handleSubmitAfter} className="sign-up-form form">
                        ...
                        <button type="submit" className="btn1 solid"  onClick={handleSubmit}>Sign up</button>
                ...
                <div className="panels-container">                  
                    ...
                    <div className="content">
                        <h3 style={{color:"white"}}><b>New here ?</b></h3>
                        <p>
                    ...
                    <div className="content">
                        <h3 style={{color:"white"}}><b>One of us ?</b></h3>
                        <p>
